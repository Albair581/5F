...
// NOTE:
// ---------------------------------------------------------------------------------//
const opened_books = ["000", "001", "003", "004", "005", "008", "009", "saytoben", "summer2025", "010", "011", "012", "teachers2025", "013", "014", "015", "016", "019", "020", "021", "022", "023", "024.1", "024.2", "winter2026"];
const beta_books = [];
const opened_courses = ["example", "rayscience"];
// ---------------------------------------------------------------------------------//
...
async function submitFeedback() {
    ...
    setTimeout(function() { alert("Submitting feedback, please wait... 正在送出回饋，請稍候... 送信中、しばらくお待ちください..."); }, 1);
    ...
    $.get(`templates/${basePage}.html`, function(data) {
        ...
        if (basePage == 'book') {
            $.get(`templates/Books/${book}.html`, function(bookd) {
                ...
                if (book == "saytoben" || book == "015" || book == "024.1") {
